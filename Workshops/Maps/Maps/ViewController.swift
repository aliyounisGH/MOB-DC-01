...
//views .. loads maps
import CoreLocation
//is mainly for tracking (the device)
...
class ViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        //best uses more resources so if not necessary, pick another one
        //best uses GPS and WiFi
    ...
    func centerMapOnLocation(location: CLLocation) {
        ...
        , self.searchRadius * 2.0, self.searchRadius * 2.0)
