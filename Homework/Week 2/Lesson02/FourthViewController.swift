...
*/
    ...
    @IBOutlet weak var myFibIndex: UITextField!
    
    
    @IBOutlet weak var theFibResult: UILabel!
...
//        }
//      
        let thisFib = FibonacciAdder()
        theFibResult.text = String(thisFib.fib(fibNum: myFibIndex.text.toInt()!)
        )
