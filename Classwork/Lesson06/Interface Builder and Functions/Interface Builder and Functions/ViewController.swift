...
class ViewController: UIViewController {
    ...
    */
    ...
    @IBOutlet weak var myFibTextField: UITextField!
    
    @IBOutlet weak var myFibLabel: UILabel!
    
    @IBAction func myFibButton(sender: AnyObject) {
        let fibNum = myFibTextField.text
        
        let calculatedFib = fib(fibNum.toInt()!)
        myFibLabel.text = "\(calculatedFib)"
    }
